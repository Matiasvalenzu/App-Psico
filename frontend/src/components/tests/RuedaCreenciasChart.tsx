      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border/60 pb-4">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Diagrama poligonal de telaraña: polígono cian de Satisfacción Actual (1-10) en cada dimensión.
          </p>
        </div>
      ...
      <div className="mt-6 grid items-center gap-8 lg:grid-cols-[1fr_320px]">
        ...
        <div className="relative mx-auto flex w-full max-w-[620px] items-center justify-center">
          ...
          >
            ...
            {/* Actual Polygon (Nivel Actual) - The Star Figure in Cyan */}
            <path
              d={actualPath}
            ...
            {/* Outer Dimension Labels (10 Life Areas) */}
            {dimensions.map((dim, i) => {
        ...
        {/* Side Panel: Selected Area & Clinical Highlights */}
        <div className="flex flex-col justify-center space-y-4">
          {activeDim ? (
            <div className="rounded-xl border border-cyan-500/30 bg-cyan-500/5 p-4 shadow-sm transition-all duration-200">
              ...
              <div className="mt-3.5 rounded-lg border border-border/80 bg-card p-3 text-center shadow-xs">
                ...
                <span className="text-xl font-bold text-cyan-700 dark:text-cyan-400">
                  {(activeDim.score ?? activeDim.actual ?? 1)}.00 <span className="text-xs font-normal text-muted-foreground">/ 10</span>
                </span>
              </div>
            ...
            <div className="rounded-xl border border-dashed border-border/80 bg-muted/20 p-5 text-center text-muted-foreground">
              ...
              <p className="mt-2 text-xs font-medium">
                Pasa el cursor por cualquier vértice o nombre del radar para ver los detalles de esa área vital.
              </p>
            </div>
          )}
            ...
            <div className="grid gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">
                  <strong className="text-cyan-700 dark:text-cyan-400">Figura Cian Sombreada:</strong> Nivel de satisfacción actual del paciente (1 al 10)
                </span>
              </div>
